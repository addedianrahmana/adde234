...
<div class="container-fluid px-4">
    ...
    <div class="card mb-2">
        <div class="card-header">
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#BrgMasuk">
                Tambah Barang Masuk
            </button>

            <!-- Modal -->
            <div class="modal fade" id="BrgMasuk" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Pemasukan Barang</h1>
                        ...
                        <form method="post">
                            <div class="modal-body">
                                ...
                                <br>
                                <input class="form-control" type="date" name="tglmasuk" id="tglmasuk" placeholder="17/08/1945" required />
                                <br>
                                <input class=" form-control" type="number" name="qtymasuk" id="qtymasuk" placeholder="Qty" required />
                                <br>
                                <input class="form-control" type="text" name="jenis" id="jenis" placeholder="MASUK" value="MASUK" required readonly />
                                <br>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="barangmasuk" id="barangmasuk">Simpan</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <table class="table table-striped table-bordered" style="width: 100%;" id="TblStokBarang">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['filter'])) {
                            ...
                            $sql = "SELECT * FROM transaksi WHERE jenis = 'MASUK' and MONTH(tglmasuk)='$selected' and YEAR(tglmasuk)='$year' ORDER BY tglmasuk DESC";
                            $query = $conn->query($sql);
                        } elseif (isset($_POST['all'])) {
                            $sql = "SELECT * FROM transaksi WHERE jenis = 'MASUK' ORDER BY tglmasuk DESC";
                            $query = $conn->query($sql);
                        } else {
                            $sql = "SELECT * FROM transaksi WHERE jenis = 'MASUK' ORDER BY tglmasuk DESC";
                            $query = $conn->query($sql);
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                ...
                                                <br>
                                                <input class="form-control" type="date" name="tglmasuk" id="tglmasuk" placeholder="17/08/1945" value="<?php echo $row['tglmasuk']; ?>" required />
                                                <br>
                                                <input class=" form-control" type="number" name="qtymasuk" id="qtymasuk" placeholder="Qty" value="<?php echo $row['qtymasuk']; ?>" required />
                                                <br>
                                                <input class="form-control" type="text" name="jenis" id="jenis" placeholder="MASUK" value="<?php echo $row['jenis']; ?>" required readonly />
                                                <br>
                                                <input class=" form-control" type="text" name="penerima" id="penerima" placeholder="Penerima" value="<?php echo $row['penerima']; ?>" required />
                                                <br>
                                                <input class=" form-control" type="text" name="keterangan" id="keterangan" placeholder="Keterangan" value="<?php echo $row['keterangan']; ?>" />
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" class="btn btn-primary" name="ubahbarangmasuk" id="ubahbarangmasuk">Simpan</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        <form method="post">
                                            ...
                                            <div class="modal-footer" style="justify-content: center; align-items:center;">
                                                <button type="submit" class="btn btn-dark btn-sm" name="hapusbarangmasuk" id="hapusbarangmasuk">OK</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function changeValue(idbarang) {
        ...
        document.getElementById('qtymasuk').placeholder = dtBarang[idbarang].stok;
    };
</script>
